...
Rectangle {
    ...
    Python {
        ...
        Component.onCompleted: {
            ...
            importModule('pythonqml', function() {
                console.log('Controller is now imported');
                
                // Asynchronous function calls
                call('pythonqml.koe', [], function(result) {
                    console.log(' TEST: ' + result);
                    //listView.model = result;
                });
                
                // Asynchronous function calls
                call('pythonqml.controller.projects.current', [], function(result) {
                    console.log(' TEST: ' + result);
                    //listView.model = result;
                });
